    ...
    <>
      ...
      >
        <Box width={"100%"}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} md={4}>
              <NewTextField {...allProps} keyProp="deliveryNo" />
            </Grid>
            <Grid item xs={12} md={4}>
              <NewSelect {...allProps} keyProp="freightType" />
            </Grid>
            <Grid item xs={12} md={4}>
              <NewSelect {...allProps} keyProp="deliveryType" />
            </Grid>
          </Grid>{" "}
          <Divider
            sx={{
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} md={4}>
              <NewNumber {...allProps} keyProp="km" />
            </Grid>
            <Grid item xs={12} md={4}>
              <NewNumber {...allProps} keyProp="kmPrice" />
            </Grid>
            <Grid item xs={12} md={4}>
