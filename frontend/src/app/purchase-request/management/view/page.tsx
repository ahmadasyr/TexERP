...
const Page: React.FC = ({ popupHandler, popupSetter }: Page) => {
  ...
  const [dataRefresh, setDataRefresh] = React.useState<boolean>(false);
          ...
          <Box display="flex" justifyContent="flex-end" mb={2}>
            ...
            formData.approvalFromManagement === false ? (
              <Button
                ...
                sx={{ ml: 2 }}
                onClick={() => {
                  fetch(`/api/purchase-request/management/true/` + id, {
                    method: "PUT",
                    headers: {
                      "Content-Type": "application/json",
                    },
            ...
            formData.approvalFromManagement === true ? (
              <Button
                ...
                sx={{ ml: 2 }}
                onClick={() => {
                  fetch(`/api/purchase-request/management/false/` + id, {
                    method: "PUT",
                    headers: {
                      "Content-Type": "application/json",
                    },
