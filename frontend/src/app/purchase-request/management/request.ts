    ...
    actionConditions: [
      {
        ...
        label: "Reddet",
        color: "error",
        action: "/api/purchase-request/management/false",
      },
      {
        value: "Hayır",
        label: "Onayla",
        color: "success",
        action: "/api/purchase-request/management/true",
      },
      {
        value: null,
        label: ["Onayla", "Reddet"],
        color: ["success", "error"],
        action: [
          "/api/purchase-request/management/true",
          "/api/purchase-request/management/false",
        ],
      },
    ],
  },
